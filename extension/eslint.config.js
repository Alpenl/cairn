...
export default defineConfig(
  ...
  // Unit tests intentionally declare several tiny inline Vue stubs in one
  // file. They are test doubles rather than production components, and their
  // props are only consumed by Vue Test Utils.
  {
    files: ['**/*.test.{ts,tsx}'],
    rules: {
