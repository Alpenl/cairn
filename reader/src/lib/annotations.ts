/**
 * Pure rendered-selection helpers for annotation surfaces.
 *
 * Durable domain values live in `annotation-domain`; storage ownership and
 * legacy import live under `lib/user-data`. This module deliberately has no
 * durable storage or React lifecycle responsibilities.
 */

import type { Annotation, AnnotationQuote } from './annotation-domain'
