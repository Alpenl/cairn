...
class ErrorClassifierTest {
    ...
    fun classifiesServerBranchesWithoutParsingHumanMessages() {
        ...
        assertEquals(ErrorKind.HTTP_429_RATE_LIMIT, ErrorClassifier.http(429, "busy", null).kind)
        assertEquals(ErrorKind.HTTP_403, ErrorClassifier.http(403, "forbidden", null).kind)
