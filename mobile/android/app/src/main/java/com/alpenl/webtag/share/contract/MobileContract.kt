...
const val REPRESENTATION_CONTRACT = "v3"
...
data class SessionIdentity(
    ...
    fun isSupported(): Boolean = representationContract == REPRESENTATION_CONTRACT
}
...
data class CredentialConfig(
    ...
    val activationRevision: Long = INITIAL_ACTIVATION_REVISION,
) {
...
const val INITIAL_ACTIVATION_REVISION = 1L
