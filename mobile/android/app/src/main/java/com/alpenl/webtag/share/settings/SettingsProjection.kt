...
/**
 * The five sections the settings queue is rendered in, in the order they are rendered.
 *
 ...
 * nothing else.
 *
 * There is deliberately no origin or installation token here. A lifecycle reload replaces this whole object,
...
internal object SettingsQueuePresenter {
    ...
    fun groupOf(state: QueueState): QueueGroup = when (state) {
        ...
        QueueState.BLOCKED_AUTH -> QueueGroup.BLOCKED_CREDENTIAL
