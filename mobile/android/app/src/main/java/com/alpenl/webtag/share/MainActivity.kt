...
internal fun SettingsScreen(
    ...
    var installationToken by remember { mutableStateOf("") }
        ...
        LazyColumn(
            ...
            item {
                OutlinedTextField(
                    ...
                    onValueChange = { installationToken = it },
                    modifier = Modifier.fillMaxWidth(),
                    label = { Text(stringResource(R.string.installation_token)) },
                    singleLine = true,
                    enabled = !busy,
                        ...
                        IconButton(onClick = { tokenVisible = !tokenVisible }) {
                            Icon(
                                ...
                                contentDescription = stringResource(
                                    if (tokenVisible) R.string.hide_installation_token else R.string.show_installation_token,
                                ),
                            )
                        }
                    },
            ...
            item {
                Button(
                    modifier = Modifier.fillMaxWidth(),
                    enabled = !busy && origin.isNotBlank() && installationToken.isNotBlank(),
                    onClick = {
                        val requestGeneration = ++connectionRequestGeneration
                        val requestedOrigin = origin
                        val requestedInstallationToken = installationToken
                        busy = true
                        connectionMessage = ""
                        scope.launch {
                            ...
                            fun restorePreviousConfiguration() {
                                previousConfiguration?.let { previous ->
                                    ...
                                    installationToken = previous.installationToken
                                } ?: run {
                                    origin = ""
                                    installationToken = ""
                                }
