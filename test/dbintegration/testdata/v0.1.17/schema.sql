...
--
-- Name: feed_lifecycle_repair_audit; Type: TABLE; Schema: public; Owner: -
--
...
CREATE TABLE public.feed_lifecycle_repair_audit (
    ...
    CONSTRAINT chk_feed_lifecycle_repair_audit_classification CHECK ((classification = ANY (ARRAY['repaired_feed_managed_orphan'::text, 'ambiguous_subscription_orphan'::text])))
);
...
--
-- Name: feed_lifecycle_repair_audit feed_lifecycle_repair_audit_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.feed_lifecycle_repair_audit
    ADD CONSTRAINT feed_lifecycle_repair_audit_pkey PRIMARY KEY (link_id, classification);
...
--
-- Name: idx_river_job_translation_terminal_history; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_river_job_translation_terminal_history ON public.river_job USING btree (finalized_at, id) WHERE ((kind = ANY (ARRAY['translate_link_v2'::text, 'translate_link_content'::text])) AND (state = ANY (ARRAY['cancelled'::public.river_job_state, 'completed'::public.river_job_state, 'discarded'::public.river_job_state])) AND (finalized_at IS NOT NULL));
